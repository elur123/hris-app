...
<>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex flex-col justify-start gap-1">
                                ...
                                <div className="flex items-center px-1">
                                    <svg aria-hidden="true" className="w-4 h-4 text-yellow-400" fill="currentColor"
                                    ...
                                    <svg aria-hidden="true" className="w-4 h-4 text-gray-300 dark:text-gray-500"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        <div className="p-4 bg-white shadow rounded" id="dev-card">
                            ...
                            <div className="py-3 text-center">
                                <span
                                    className="px-2 py-1 bg-green-50 rounded-lg text-green-500 font-bold">09555347395</span>
                            </div>
                        ...
                        <div className="p-4 bg-white shadow rounded">
                            <div className="mb-3">
                                ...
                                <p className="my-2 p-3 border rounded-lg font-bold text-3xl text-cyan-900 text-center">
                                    {timeString}</p>
                            </div>
                            <div className="mb-3">
                            ...
                            <Button
                                className="w-full my-2 px-4 py-2 text-center text-cyan-900 font-bold bg-amber-100 rounded-lg ">Clock
                                Out</Button>
                        </div>
                    </div>
                        ...
                        <div className="p-4 bg-white shadow rounded">
                            <div className="flex flex-wrap gap-2">
                                <div className="pr-6 md:border-r-2">
                                    ...
                                    <Button
                                        className="my-2 px-2 py-1 flex items-center gap-1 text-sm text-cyan-900 border border-cyan-800 rounded-lg">
                                ...
                                <div className="px-2 flex flex-wrap justify-evenly flex-1 gap-4 content-end">
                                    ...
                                    <div className="flex flex-col items-center">
                                        <span
                                            className="w-full h-full py-3 text-cyan-100 bg-cyan-100 rounded-md">t</span>
                                        <span>Feb</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <span
                                            className="w-full h-full py-5 text-cyan-100 bg-cyan-100 rounded-md">t</span>
                                        <span>Mar</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <span
                                            className="w-full h-full py-4 text-cyan-100 bg-cyan-100 rounded-md">t</span>
                                        <span>Apr</span>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <span
                                            className="w-full h-full py-2 text-cyan-100 bg-cyan-100 rounded-md">t</span>
                                        <span>May</span>
                                    </div>
                                </div>
                            </div>
        ...
        <div className="w-full mt-8 p-2 md:p-4 flex flex-wrap md:flex-nowrap gap-2 md:gap-4">
            <div className="p-3 w-full h-[360px] group overflow-hidden flex flex-col justify-between bg-white rounded-xl hover:bg-cyan-900 hover:gap-2"
                ...
                <div id="icon" className="w-10 p-1 bg-gray-100 rounded-xl group-hover:bg-green-300">
                    <svg className="w-6 h-6 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div className="w-full transition-all ease-in-out delay-150 group-hover:flex-1" id="content">
                    <div id="header">
                        ...
                        <h3 className="py-2 text-cyan-800 text-2xl font-bold group-hover:text-white">Focus on Thing That
                            Are More Important</h3>
                    </div>
                    <div id="body"
                        className="w-full h-0 transition-all ease-in-out delay-150 opacity-0 group-hover:h-full group-hover:opacity-100">
                        <p className="w-full text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    ...
                    <div className="my-4">
                        <p className="flex mb-3 items-center gap-5 text-gray-400">
                            <span className="w-4 h-4 rounded-full bg-green-500">
                                <svg className="w-4 h-4 text-white font-bold" xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="p-3">
                ...
                <div className="my-3">
                    <p className="py-3 text-gray-400 italic">
                        "With everthing explained, onboarding was impressive. Humanage always goes the extra mile by
                        improving the product regulary with updates".
                    </p>
                </div>
                <p className="py-0 text-gray-400"><span className="text-cyan-900 font-extrabold">Ericka Ocaris,</span>
                    Senior HR Manager</p>
            </div>
        </div>
    </section>
    ...
    <footer className="container mx-auto px-2 my-4 py-4 md:my-8 md:px-0 md:pb-0 md:pt-8">
        <div className="py-3 flex justify-between border-b-2 items-center">
            ...
            <div className="flex gap-2 items-center">
                <svg className="w-5 h-5" viewBox="0 0 32 32" version="1.1"
        ...
        <div className="my-3 flex flex-wrap md:flex-nowrap justify-between">
            <nav>
                ...
                <ul>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Payroll</a>
                    </li>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Time attendance</a>
                    </li>
                </ul>
            </nav>
            <nav>
                <h4 className="py-3 text-xl text-gray-400 font-bold">Company</h4>
                <ul>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">About us</a>
                    </li>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Careers</a>
                    </li>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Partner with us</a>
                    </li>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Request a demo</a>
                    </li>
                </ul>
            </nav>
            <nav>
                <h4 className="py-3 text-xl text-gray-400 font-bold">Resources</h4>
                <ul>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Support center</a>
                    </li>
                    <li className="mb-2">
                        <a className="text-cyan-900 font-bold" href="">Blog</a>
                    </li>
                </ul>
            </nav>
            <div className="w-80">
                <h4 className="py-3 text-xl text-gray-400 font-bold">Newsletters</h4>
                <div className="py-2 w-full">
                    <input className="w-full border border-gray-400 focus:ring-green-400 focus:border-green-500 rounded-xl" type="text" placeholder='Email' />
                </div>
                <div className="py-3 w-full">
                    <Link href={route('login')} className="block w-full text-center px-4 py-2 font-extrabold bg-green-500 text-white rounded-lg">Get Newsletter</Link>
                </div>
            </div>
        </div>
        <div className="my-3 pt-6 flex justify-between items-center">
            <a className="text-lg text-cyan-900 font-bold" href="">
                © 2023 Humanage, Inc. All right reserved
            </a>
            <div className="flex items-center gap-4">
                <a className="text-lg text-cyan-900 font-bold" href="">Privacy Policy</a>
                <a className="text-lg text-cyan-900 font-bold" href="">Terms & Conditions</a>
            </div>
        </div>
    </footer>
</>
